    ...
    <>
      ...
      >
        ...
        <Flex
          ...
          animation="headerFade 0.3s ease forwards"
        >
          {!isOpenedList ? <FileUploader /> : ""}

          {isOpenedList ? (
            <Button
              onClick={() => {
                SoundPlay(ListsSound, false, false);
              }}
              borderRadius="full"
          ...
          {!isOpenedList ? (
            <Button
              ...
              h={{ base: "50px", "2xl": "55px" }}
              onClick={() => {
                SoundPlay(ListsSound, true, true);
              }}
            >
              <Menu />
            </Button>
          ...
          >
            ...
            >
              <Button
                ...
                _hover={{ opacity: 1 }}
                _active={{ opacity: 1, transition: { base: "all 0.5s ease" } }}
                padding="none"
                borderRadius="none"
                h="40px"
                bg="red"
                border={isID === 1 ? "14px double black" : ""}
                borderBottom="none"
                roundedTopLeft="20px"
                overflow="hidden"
                ml={{
                  base: isID === 1 ? "-4.5px" : "none",
                  xl: isID === 1 ? "-4.5px" : "none"
                }}
                ...
                fontFamily="fantasy"
                fontSize={{ base: "18px", md: "20px", xl: "18" }}
                display="flex"
              ...
              <Button
                ...
                padding="none"
                borderRadius="none"
                border={isID === 2 ? "14px double black" : ""}
                borderBottom="none"
                roundedTopLeft="20px"
                overflow="hidden"
                roundedTopRight="20px"
