  ...
  return (
    <>
      <Box
        ...
        mt={{ base: "40px", xl: "10px" }}
        pos="relative"
        transform="translateY(10px)"
        animation="fadeIn 1s ease forwards"
      >
        <Box
          border="2px solid #6bea38ff"
          ml={-3}
          position="relative"
          rounded="full"
          p="2px"
          animation={
            isPlayed
              ? `${rotate} 50s linear 0.5s infinite`
              : "fadeIn2 1s ease forwards"
          }
        >
          <Image
            src={MusicPIC}
          ...
          <Text
            position="absolute"
            top={{ base: "85px", xl: "92px" }}
            left={{ base: "90px", xl: "96px" }}
            bg="black"
            w="60px"
            h="60px"
            border="4px double #6bea38ff"
            rounded="full"
          />
        </Box>
        ...
        <Image
          ...
          animation={
            isPlayed
              ? `${NotearmPlay} 0.3s linear forwards`
              : `${NotearmPause} 0.5s linear forwards`
          }
